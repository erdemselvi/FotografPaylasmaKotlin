...
class FeedRecyclerAdapter(val postList: ArrayList<Post>) : RecyclerView.Adapter<FeedRecyclerAdapter.PostHolder>(){
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        holder.itemView.item_row_kullanici_yorumu.text=postList[position].kullaniciYorum
        //Resim eklemek için Picasso android eklentisi yükledik ve kodu yazıyoruz
